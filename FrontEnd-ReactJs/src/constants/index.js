...
const PAYMENTS = [
    ...
    { type: 2, label: 'VNPay', info: 'VNPay' },
    { type: 3, label: 'Tiền mặt', info: 'Tiền mặt' }
]
...
const LIST_QUESTION_CHATBOT = [
    {
        role: 'assistant',
        content: "Chào mừng bạn đến với TMTT Store, hiện tại bạn đang nhắn tin với một chatBot, thông tin có thể sai lệch so với thực tế."
    },
    {
        role: 'assistant',
        content: "Để đảm bảo bạn cần những thông tin chính xác với nhu cầu. Bạn vui lòng đăng nhập để nhắn tin với người quản trị và lưu trữ tin nhắn."
    },
    // {
    //     role: 'assistant',
    //     content: "Nếu không, hãy tận hưởng những hữu ích mà chatBot đem lại xin cảm ơn!"
    // },
    {
        role: 'system',
        content: "Chat bằng tiếng việt",
    },
    // {
    //     role: 'system',
    //     content: "Tâp trung toàn bộ vào chủ đề máy tính, trang thiết bị điện tử",
    // },
    // {
    //     role: 'system',
    //     content: "Cửa hàng TMTT Store và thương hiệu do anh Trịnh Minh Thái Tố thành lập",
    // },
    // {
    //     role: 'system',
    //     content: 'Không trả lời các câu hỏi không liên quan đến máy tính, hay trang thiết bị điện tử',
    // }
]
