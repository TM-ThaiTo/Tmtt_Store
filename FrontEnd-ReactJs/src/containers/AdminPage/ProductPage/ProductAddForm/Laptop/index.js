...
class Laptop extends Component {
    ...
    getInfoLaptop = () => {
        ...
        const cpu = form.getFieldValue("chipBrand");
        const processorCount = form.getFieldValue("processorCount");
        const series = form.getFieldValue("series");
        const detailCpu = form.getFieldValue("detail");
        const displaySize = form.getFieldValue("displaySize");
        const display = form.getFieldValue("display");
        const operating = form.getFieldValue("operating");
        const disk = form.getFieldValue("disk");
        const ram = form.getFieldValue("ram");
